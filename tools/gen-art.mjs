...
const DECO_ART = {
  ...
  // Seen from the foot of the bed: headboard across the far (top) edge, a
  // pillow below it, mattress running toward the viewer between wood rails,
  // footboard + legs at the near (bottom) edge.
  bed: {
    palette: { K: "#6b4a2f", L: "#a9744a", w: "#eef2f7", p: "#9ec7ee" },
    pixels: [
      "...KKKKKKKKKK...",
      "...KKKKKKKKKK...",
      "...KppppppppK...",
